...
&emsp;&emsp;&emsp; $f(x;v) =\frac{&Gamma;(\frac{v+1}{2})}{\sqrt{v}\pi &Gamma;(\frac{v}{2})} (1 + \frac{t^2}{v})^{-\frac{v+1}{2}}$
...
&emsp;&emsp;&emsp;$f(x;d_1, d_2) = \frac{\sqrt{\frac{(d_1x)^{d_1} d_2^{d_2}}{(d_1x +d_2)^{d_1+d_2}}}}{xB(\frac{d_1}{2}, \frac{d_2}{2})}$