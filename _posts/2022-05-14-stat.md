...
$y&#772;= $ mean of the values of the y-variable<br>

For population data, correlation coefficient is defined as :<br>
...
where,
$&rho;$ denotes _Pearson Correlation Coefficient_ of rank variables, $cov(R(X),R(Y))$ is covariance of rank variables $&sigma;_(R(X))$ and $&sigma;_(R(Y))$ are standard deviations of rank variables.
...
where $&mu;$ is the mean of the population and $&sigma;$ is s.d. of the population. And, for sample,

$z = \frac{x-x&#772;}{S}$ where $x&#772;$ is the mean of the sample, and $S$ is the s.d. of the sample.
